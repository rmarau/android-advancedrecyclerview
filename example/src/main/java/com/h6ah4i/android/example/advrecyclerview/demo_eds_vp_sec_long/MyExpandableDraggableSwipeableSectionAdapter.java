...
class MyExpandableDraggableSwipeableSectionAdapter
        extends AbstractExpandableItemAdapter<MyExpandableDraggableSwipeableSectionAdapter.MyGroupViewHolder, MyExpandableDraggableSwipeableSectionAdapter.MyChildViewHolder>
        implements ExpandableDraggableItemAdapter<MyExpandableDraggableSwipeableSectionAdapter.MyGroupViewHolder, MyExpandableDraggableSwipeableSectionAdapter.MyChildViewHolder>,
        ExpandableSwipeableItemAdapter<MyExpandableDraggableSwipeableSectionAdapter.MyGroupViewHolder, MyExpandableDraggableSwipeableSectionAdapter.MyChildViewHolder> {
    ...
    public MyExpandableDraggableSwipeableSectionAdapter(
...
//        return 0;
    ...
    private void onBindItemGroupViewHolder(MyGroupViewHolder holder, int groupPosition) {
        ...
        if (((dragState & Draggable.STATE_FLAG_IS_UPDATED) != 0) ||
            ...
            } else if ((swipeState & Swipeable.STATE_FLAG_IS_ACTIVE) != 0) { //The One being swipe
                bgResId = R.drawable.bg_group_item_swiping_active_state;
            } else if ((swipeState & Swipeable.STATE_FLAG_SWIPING) != 0) { //The others...
            ...
            /* Testing Layout change while expanding */
            FrameLayout parent = ((FrameLayout)holder.mContainer.getParent());
            ViewGroup.LayoutParams lp = parent.getLayoutParams();
            lp.height = parent.getContext().getResources().getDimensionPixelSize(R.dimen.list_group_item_height);
            if (isExpanded) lp.height += 20;
...
//        return new ChildPositionItemDraggableRange(start, end);
    ...
    private static class GroupSwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        private MyExpandableDraggableSwipeableSectionAdapter mAdapter;
        private final int mGroupPosition;
        private boolean mSetPinned;

        GroupSwipeLeftResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition) {
            mAdapter = adapter;
    ...
    private static class GroupSwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        GroupSwipeRightResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
        }
    ...
    private static class GroupUnpinResultAction extends SwipeResultActionDefault {
        ...
        GroupUnpinResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
        }
    ...
    private static class ChildSwipeLeftResultAction extends SwipeResultActionMoveToSwipedDirection {
        ...
        ChildSwipeLeftResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
    ...
    private static class ChildSwipeRightResultAction extends SwipeResultActionRemoveItem {
        ...
        ChildSwipeRightResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
            mChildPosition = childPosition;
        }
    ...
    private static class ChildUnpinResultAction extends SwipeResultActionDefault {
        ...
        ChildUnpinResultAction(MyExpandableDraggableSwipeableSectionAdapter adapter, int groupPosition, int childPosition) {
            mAdapter = adapter;
            mGroupPosition = groupPosition;
            mChildPosition = childPosition;
        }
